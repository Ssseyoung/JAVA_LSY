...
public class FileInputTxt {
	...
	public static void main(String[] args) {
		...
		try {
			// Day09_FileInputTxt.txt 파일을 입력할 수 있도록 연결
			fis = new FileInputStream("Day09_FileInputTxt.txt");
			...
			e.printStackTrace();	// 예외 발생 원인을 찾아 단계별로 예외 메세지를 출력
			System.err.println("파일을 찾을 수 없습니다.");
		}
		catch (IOException e) {
			// IOException : 입출력 과정에서 문제 시 발생하는 예외 (I:input, O:output)
			e.printStackTrace();
